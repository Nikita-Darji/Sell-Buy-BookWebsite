...
<section class="home">
   ...
   <div class="content">
      <h3>We have books <br>that you need. </h3>
      <p>Anyone can sell their books to the needy one.</p>
   </div>
...
<section class="products">
   ...
   <?php  
         $select_products = mysqli_query($conn, "SELECT * FROM img LIMIT 8") or die('query failed');
